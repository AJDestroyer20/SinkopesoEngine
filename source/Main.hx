...
import ui.KadeEngineFPS;
import scripting.ModCore;
import context.GameContext;
import ui.menu.TitleState;
...
class Main extends Sprite
{
	...
	private function setupGame():Void
	{
		...
		// ── SinkopesoEngine: GameContext ────────────────────────────────
		// Reads data.json, boots AudioManager, ModRegistry, EventBus.
		GameContext.init();
